...
#
#   gateway(request) -> list(status = integer, body_text = character)
#
# where `request` is a named list with fields `method`, `url`, and
# `headers` (named character vector).  Tests substitute their own
