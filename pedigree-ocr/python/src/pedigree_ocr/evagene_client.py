...
Mirrors the client the ``call-notes-to-pedigree`` demo uses, including
the workaround for the add-relative and proband-designation endpoints
whose success bodies are ignored.
"""
